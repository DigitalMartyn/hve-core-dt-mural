...
* **Mural Export:** At space boundaries (3→4, 6→7) or after methods that produce visual artifacts (M1, M3, M4, M5, M6), mention: "You can also export these artifacts to a Mural board for team review using `/dt-mural-export`."
